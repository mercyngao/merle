...
private void initComponents() {
    ...
    table.setModel(new javax.swing.table.DefaultTableModel(
        new Object [][] {
        		{1, "Gumaryili", 1, "functioning" },
                {2, "Selinvoya", 1, "functioning" },
                {3, "Selinvoya", 1, "functioning"  },
                {4, "Selinvoya", 1, "functioning"  },
                {5, "Selinvoya", 1, "functioning"  },
                {6, "Selinvoya", 1, "newly constructed" },
                {7, "Selinvoya", 1, "functioning" },
                {8, "Selinvoya", 1, "newly constructed" },
                {9, "Selinvoya", 1, "newly constructed" },
                {10, "Selinvoya", 1, "functioning"  },
                {11, "Selinvoya", 1, "newly constructed"},
                {12, "Selinvoya", 1, "functioning"  },
                {13, "Selinvoya", 1, "functioning"  },
                {14, "Selinvoya", 1, "newly constructed" },
                {16, "Nabulugu", 1, "newly constructed" },
                {17, "Nabulugu", 1, "abandoned" },
        },
        new String [] {
                "Rank", "Community Name", "Water Point", "waterpoint condition", 
        }
    ));
